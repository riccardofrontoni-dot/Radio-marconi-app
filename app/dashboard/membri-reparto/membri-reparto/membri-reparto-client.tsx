...
type Task = { id: string; titolo: string; completato: boolean; assegnato_a: string | null; puntata_data: string | null; descrizione: string | null };
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  {taskMembro.map((t) => (
                    <div key={t.id} style={{ display: "flex", alignItems: "center", gap: 8, background: "var(--light-bg)", borderRadius: 10, padding: "8px 10px" }}>
                      <button
                        onClick={() => spunta(t.id, t.completato)}
                        style={{ width: 16, height: 16, borderRadius: "50%", border: t.completato ? "none" : "1.5px solid var(--border)", background: t.completato ? "var(--blue)" : "transparent", cursor: "pointer", padding: 0, flexShrink: 0 }}
                      />
